...
public class ZipFileCSVComparatorTest {
  ...
  public void testEmptySame() throws IOException, NoSuchAlgorithmException {
    ...
    boolean isSame = zipFileCSVComparator.compareCSVFilesInZip(targetZipPath, expectedZipPath,
  ...
  public void testNotEmptyNotSameCSVFiles() throws IOException, NoSuchAlgorithmException {
    String targetZipPath = getClass().getClassLoader().getResource("diff/a-diff1_csv.zip")
        .getPath();
    String expectedZipPath = getClass().getClassLoader().getResource("diff/b-diff2_csv.zip")
        .getPath();
